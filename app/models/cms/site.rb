module Cms
  class Site < ActiveRecord::Base
    ...
    # returns the requested page, or a RedirectedPage containing the target url
    def find_published_page!(path)
      page = pages.published.find_by_full_path!(path)
      page.target_page ? RedirectedPage.new(page.target_page.url) : page
    end
